...
async def update(request: Request, user_id: int, name: str = Form(...), fixed_acidity: float = Form(...), volatile_acidity: float = Form(...), citric_acid: float = Form(...), chlorides: float = Form(...), total_sulfur_dioxide: float = Form(...), density: float = Form(...), sulphates: float = Form(...), alcohol: float = Form(...), model: str = Form(...), db: Session = Depends(get_db)):
    ...
    # Update user's information including the predicted quality and the model used
    user.name = name
    ...
    user.model_used = model  # Update model used
    user.best_probability = best_probability  # Assign best_probability to user
